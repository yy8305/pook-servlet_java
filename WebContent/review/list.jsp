...
<body>
	...
	<div class="container">
		...
		<div id="subMenu">
			<ul>
				<li class="on"><a href="/ReviewList">맛집리뷰</a></li>
			</ul>
		</div>
		<div id="contents">
			<h3>맛집리뷰<span>사용자들이 직접 올릴수 있는 맛집 리뷰 페이지 입니다.</span></h3>
			<ul class="location">
				<li>Home</li>
				<li>맛집리뷰</li>
				<li>맛집리뷰</li>
			</ul>
			<form name="searchFrm" action="/ReviewList" method="get">
				<div class="searchBox">
			...
			<ul class="listType img">
				<c:forEach var="boardList" items="${BoardList}">
					<li>
						<div class="img">
							<a href="review_view.html">
								<span class="icon_news">new</span>
								<img src="/images/contents/img_no.png" alt="제26기 결산공고(2015년)">
							</a>
						</div>
						<div class="txt">
							<a href="review_view.html">${boardList.title}</a>
			...
			<c:if test="${sessionScope.user_id ne null and sessionScope.user_id ne ''}">
				<div class="btnAreaR">
					<a href="/ReviewWrite" class="btn btnSubmit">글쓰기</a>
				</div>
			</c:if>
		</div>
		<div id="footer">
