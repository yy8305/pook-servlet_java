...
<body>
	...
	<div class="container">
		<div id="header">
			...
			<div id="topMenu">
				<ul>
					...
					<li class="on"><a href="/CommunityList">맛커뮤니티</a>
						<ul>
		...
		<div id="contents">
			<h3>맛커뮤니티<span>사용자들이 서로 커뮤니팅 활동을 할 수 있습니다.</span></h3>
			<ul class="location">
				<li>Home</li>
				<li>맛커뮤니티</li>
				<li>맛커뮤니티</li>
			</ul>
			<form name="searchFrm" action="/CommunityList" method="get">
				<div class="searchBox">
			...
			<div class="cb"></div>
			<ul class="listType img type2">
				<c:forEach var="boardList" items="${BoardList}">
					<li>
						<span class="icon_sale">new</span>
						<div class="txt">
							<a href="/CommunityView?idx=${boardList.idx}">${boardList.title}</a>
							<span><a href="#"><img src="/images/btn/btn_file.png" alt="파일 다운로드"></a></span>
						</div>
						<div class="date">
							<div><span>등록일</span> ${boardList.write_date}</div>
						</div>
						<div class="cb"></div>
					</li>
				</c:forEach>
			...
			<c:if test="${sessionScope.user_id ne null and sessionScope.user_id ne ''}">
				<div class="btnAreaR">
					<a href="/CommunityWrite" class="btn btnSubmit">글쓰기</a>
				</div>
			</c:if>
		</div>
		<div id="footer">
